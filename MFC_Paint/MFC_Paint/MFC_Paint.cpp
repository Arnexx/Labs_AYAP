...
// MFC_Paint.cpp : Определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CMFC_PaintApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// создание CMFC_PaintApp

CMFC_PaintApp::CMFC_PaintApp()
{
...
// Единственный объект CMFC_PaintApp

CMFC_PaintApp theApp;


// инициализация CMFC_PaintApp

BOOL CMFC_PaintApp::InitInstance()
{
